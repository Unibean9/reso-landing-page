...
// Component by Ansh — github.com/ansh-dhanani (React Bits)
...
function GradualBlur(props: GradualBlurProps) {
  ...
  const containerStyle: CSSProperties = useMemo(() => {
    ...
    if (isVertical) {
      ...
      baseStyle.width =
        (responsiveWidth as string | undefined) || (responsiveHeight as string | undefined);
...
(GradualBlurMemo as unknown as { CURVE_FUNCTIONS: typeof CURVE_FUNCTIONS }).CURVE_FUNCTIONS =
  CURVE_FUNCTIONS;
